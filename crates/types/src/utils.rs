...
impl Opcode {
    pub fn get_name(&self) -> &'static str {
        match self {
            ...
            //
            Opcode::local_load => "local.load",
            Opcode::local_load32 => "local.load32",
            ...
            Opcode::local_load_f64 => "local.load_f64",
            Opcode::local_load32_f32 => "local.load32_f32",
            Opcode::local_store => "local.store",
            Opcode::local_store32 => "local.store32",
            Opcode::local_store16 => "local.store16",
            Opcode::local_store8 => "local.store8",
            //
            Opcode::local_long_load => "local.long_load",
            Opcode::local_long_load32 => "local.long_load32",
            ...
            Opcode::local_long_load_f64 => "local.long_load_f64",
            Opcode::local_long_load32_f32 => "local.long_load32_f32",
            Opcode::local_long_store => "local.long_store",
            ...
            //
            Opcode::data_load => "data.load",
            Opcode::data_load32 => "data.load32",
            ...
            Opcode::data_load_f64 => "data.load_f64",
            Opcode::data_load32_f32 => "data.load32_f32",
            Opcode::data_store => "data.store",
            Opcode::data_store32 => "data.store32",
            Opcode::data_store16 => "data.store16",
            Opcode::data_store8 => "data.store8",
            //
            Opcode::data_long_load => "data.long_load",
            Opcode::data_long_load32 => "data.long_load32",
            ...
            Opcode::data_long_load_f64 => "data.long_load_f64",
            Opcode::data_long_load32_f32 => "data.long_load32_f32",
            Opcode::data_long_store => "data.long_store",
            ...
            //
            Opcode::heap_load => "heap.load",
            Opcode::heap_load32 => "heap.load32",
            ...
            Opcode::heap_load_f64 => "heap.load_f64",
            Opcode::heap_load32_f32 => "heap.load32_f32",
            Opcode::heap_store => "heap.store",
