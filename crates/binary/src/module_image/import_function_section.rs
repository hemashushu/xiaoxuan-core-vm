...
use ancvm_types::entry::ImportFunctionEntry;
...
impl<'a> ImportFunctionSection<'a> {
    ...
    pub fn convert_from_entries(entries: &[ImportFunctionEntry]) -> (Vec<ImportFunctionItem>, Vec<u8>) {
...
mod tests {
    ...
    use crate::module_image::{
        import_function_section::{ImportFunctionItem, ImportFunctionSection},
        SectionEntry,
    };
