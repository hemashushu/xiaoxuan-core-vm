...
use ancvm_types::entry::ExternalFunctionEntry;
...
impl<'a> ExternalFunctionSection<'a> {
    ...
    pub fn convert_from_entries(entries: &[ExternalFunctionEntry]) -> (Vec<ExternalFunctionItem>, Vec<u8>) {
...
mod tests {
    use crate::module_image::{
        external_function_section::{ExternalFunctionEntry, ExternalFunctionItem, ExternalFunctionSection},
        SectionEntry,
    };
