...
mod tests {
    ...
    use anc_isa::OPERAND_SIZE_IN_BYTES;
    use anc_memory::primitive_memory_access::PrimitiveMemoryAccess;

    use crate::{stack::Stack, INIT_STACK_SIZE_IN_BYTES};
...
//         let mut stack = SimpleStack::new(INIT_STACK_SIZE_IN_BYTES);
//
//         // because there is bounds check in the 'pop..' operations, the 'pop..' functions
//         // will panic without a frame.
//         stack.create_empty_frame();
//
//         const FRAME_SIZE_IN_BYTES: usize = size_of::<FrameInfoData>();
...
//         let f0b = stack.get_function_frame_info();
//         assert_eq!(f0, f0b);
//
...
//         assert_eq!(f3, f3b);
//
//         assert_eq!(stack.get_frame_info_by_reversed_index(1).address, fp2);
//         assert_eq!(stack.get_frame_info_by_reversed_index(2).address, fp1);
//         assert_eq!(stack.get_frame_info_by_reversed_index(3).address, fp0);
//
//         // check local variables
//         assert_eq!(
//             stack.get_frame_local_variables_start_address_by_reversed_index(0),
...
//         assert_eq!(isfunc0, FrameType::Function);
//
//         // the current layout
//         //
//         // SP--> 0d0080 |        |
...
//         assert_eq!(isfunc1, FrameType::Block);
//
//         // the current layout (partial)
//         //
//         // SP--> 0d0128 |        |
...
//         assert_eq!(isfunc2, FrameType::Block);
//
//         // nothings changes
//         assert_eq!(stack.fp, 80);
//         assert_eq!(stack.sp, 128);
...
//         assert_eq!(isfunc3, FrameType::Block);
//
//         // the current layout (partial)
//         //
//         // SP--> 0d0128 |        |
...
//         assert_eq!(isfunc4, FrameType::Function);
//
//         // the current layout
//         //
//         // SP--> 0d0080 |        |
