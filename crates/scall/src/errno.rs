...
/*
#[cfg(any(target_os = "linux", target_os = "redox", target_os = "fuchsia"))]
pub mod result {
    extern "C" {
        fn __errno_location() -> *mut u32;
    }

    /// get the value of symbol 'errno' of std lib.
    pub fn get_errno() -> u32 {
        // there is also another method to obtain the last os error number:
        //
        // ```
        ...
        // ```
        //
        // however, it lacks a way to set the value.
