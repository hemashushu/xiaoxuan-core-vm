...
pub enum EnvCallCode {
    ...
    thread_id = 0x140,          // get the current thread id
                                // 'fn () -> thread_id:u32'
    ...
    // time
    time_now = 0x180,           // get the current time
                                // `fn () -> (seconds:u64, nano_seconds:u32)`
                                // valid values of 'nano_seconds' are [0, 999_999_999]

    // regex
    regex_create = 0x1c0,       // ref: https://github.com/rust-lang/regex
    regex_match,
    regex_test,
    regex_remove,
}

pub const MAX_ECALLCODE_NUMBER: usize = 0x200;
